...
% 
% This project is maintained at https://github.com/M1lan/LoremTeXum-ES 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% It is supposed to contribute to the Freedom of those who want to
% create really nice papers.
% I thought it might be something to share, so have fun with it.
% Lines that begin with a % are comments.
  
% The preamble, where everything that will be required further on is loaded

% we want an 4a paper article fontsize 12
...
% SafeAssign. In rare cases you may have to adjust the file encoding of your editor
% to iso-latin1 or iso-8859-1 (if you don't know, you probably don't have to.)
...
% those usually matter but here we don't care, since we don't use \maketitle
\author{}
\title{}
\date{}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% End of the preamble, the actual document begins below:
\begin{document}
